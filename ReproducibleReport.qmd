...
pp_check(zoi_te_00)
pp_check(zoi_te_00, type = 'ecdf_overlay')
conditional_effects(zoi_te_00)
modelsummary(zoi_te_00)


zoi_te_01 <- 
 brm(
    bf(
      performance_score_topic_zo ~ practice,
      phi ~ practice,
      coi ~ practice,
      zoi ~ practice
    ),
...
pp_check(zoi_te_01)
pp_check(zoi_te_01, type = 'ecdf_overlay')
conditional_effects(zoi_te_01)
modelsummary(list(zoi_te_00,zoi_te_01))

zoi_te_02 <- 
 brm(
    bf(
      performance_score_topic_zo ~ practice + (1|Topic),
      phi ~ practice + (1|Topic),
      coi ~ practice + (1|Topic),
      zoi ~ practice + (1|Topic)
    ),
    family = zero_one_inflated_beta(),
    data = data_examperformance_and_practice,
    init = "0",
...
pp_check(zoi_te_02)
pp_check(zoi_te_02, type = 'ecdf_overlay')
conditional_effects(zoi_te_02)
modelsummary(list(zoi_te_00,zoi_te_01, zoi_te_02))
...
## Zero-one-inflated beta-regression models (ab hier von Samuel)
```{r}
#| cache: true
...
######Wieso taucht hier niemals UV auf????
zoib04 <- 
  brm(
    bf(
      performance_score_topic_zo ~ practice + (1 + practice|Topic) + (UV|PID),
      phi ~ practice*Topic + (UV|PID),
      coi ~ practice*Topic + (UV|PID),
      zoi ~ practice*Topic + (UV|PID)
    ),
    family = zero_one_inflated_beta(),
    data = data_examperformance_and_practice,
    init = "0",
...
zoib05 <- 
  brm(
    bf(
      performance_score_topic_zo ~ practice + (1 + practice|Topic) + (1|PID) + (1|UV),
      phi ~ practice*Topic + (1|PID) + (1|UV),
      coi ~ practice*Topic + (1|PID) + (1|UV),
      zoi ~ practice*Topic + (1|PID) + (1|UV)
    ),
    family = zero_one_inflated_beta(),
    data = data_examperformance_and_practice,
    init = "0",
